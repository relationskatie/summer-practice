...
func GetDataFromClient(text string, salary string, area string, experience string) ([]model.ClientDTO, error) {
	var (
		log    *zap.Logger
		client *Client
		err    error
	...
	vacancies, err := client.handleClientDo(text, salary, area, experience)
	if err != nil {
